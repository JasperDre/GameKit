 ...
 * =====================================================================================
 */
#ifndef GameKit_SCENEOBJECT_HPP_
#define GameKit_SCENEOBJECT_HPP_
...
class SceneObject {
	public:
		...
		void debug() const {
			GameKitDebug() << "=== Component list of object:" << (void*)this << "===";
			GameKitDebug() << "=== List address:" << (void*)&m_components;

			for(auto &it : m_components) {
				GameKitDebug() << it.first << ":" << (void*)it.second.get();
			}

			GameKitDebug() << "=== End of list. ===";
		}
...
#endif // GameKit_SCENEOBJECT_HPP_
