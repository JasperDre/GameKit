 ...
 * =====================================================================================
 */
#ifndef GameKit_COLOR_HPP_
#define GameKit_COLOR_HPP_
...
///
/// GameKit::Color is a simple color class composed of 4 components:
/// \li Red
/// \li Green
/// \li Blue
/// \li Alpha (opacity)
...
///
/// \code
/// GameKit::Color color(255, 0, 0); // red
...
/// \code
/// GameKit::Color black       = GameKit::Color::Black;
/// GameKit::Color white       = GameKit::Color::White;
/// GameKit::Color red         = GameKit::Color::Red;
/// GameKit::Color green       = GameKit::Color::Green;
/// GameKit::Color blue        = GameKit::Color::Blue;
/// GameKit::Color yellow      = GameKit::Color::Yellow;
/// GameKit::Color magenta     = GameKit::Color::Magenta;
/// GameKit::Color cyan        = GameKit::Color::Cyan;
/// GameKit::Color transparent = GameKit::Color::Transparent;
/// \endcode
///
