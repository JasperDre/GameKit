 ...
 * =====================================================================================
 */
#ifndef GameKit_APPLICATIONSTATESTACK_HPP_
#define GameKit_APPLICATIONSTATESTACK_HPP_
...
class ApplicationStateStack {
	public:
		////////////////////////////////////////////////////////////
		/// \brief Push a new GameKit::ApplicationState to the stack
		///
...
#endif // GameKit_APPLICATIONSTATESTACK_HPP_

////////////////////////////////////////////////////////////
/// \class GameKit::ApplicationStateStack
/// \ingroup core
///
/// GameKit::ApplicationStateStack is a stack container of GameKit::ApplicationState instances.
///
/// Usage example:
/// \code
/// // In a GameKit::CoreApplication subclass
/// m_stateStack.push<MyApplicationState>(...);
///
/// // In a GameKit::ApplicationState subclass
/// m_stateStack->push<MyApplicationState>(...);
///
/// // Everywhere else
/// GameKit::ApplicationStateStack::getInstance().push<MyApplicationState>(...);
/// \endcode
///
/// \see GameKit::ApplicationState
///
////////////////////////////////////////////////////////////
