 ...
 * =====================================================================================
 */
#ifndef GameKit_VECTOR3_HPP_
#define GameKit_VECTOR3_HPP_
...
namespace std {
	template<typename T>
	struct hash<GameKit::Vector3<T>> {
		size_t operator()(const GameKit::Vector3<T> &vector3) const {
			std::hash<T> hash;
