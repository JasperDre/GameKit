 ...
 * =====================================================================================
 */
#ifndef GameKit_RECT_HPP_
#define GameKit_RECT_HPP_
...
/// (Vector2 and Vector3).
///
/// To keep things simple, GameKit::Rect doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// GameKit::Rect uses the usual rules for its boundaries:
/// \li The left and top edges are included in the rectangle's area
/// \li The right (left + width) and bottom (top + height) edges are excluded from the rectangle's area
///
/// This means that GameKit::IntRect(0, 0, 1, 1) and GameKit::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// GameKit::Rect is a template and may be used with any numeric type, but
/// for simplicity the instantiations used by GameKit are typedef'd:
/// \li GameKit::Rect<int> is GameKit::IntRect
/// \li GameKit::Rect<float> is GameKit::FloatRect
///
...
/// GameKit::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with a size of 18x10
/// GameKit::Vector2i position(4, 2);
/// GameKit::Vector2i size(18, 10);
/// GameKit::IntRect r2(position, size);
///
