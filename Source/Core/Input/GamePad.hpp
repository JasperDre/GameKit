 ...
 * =====================================================================================
 */
#ifndef GameKit_GAMEPAD_HPP_
#define GameKit_GAMEPAD_HPP_
...
class GamePad {
	public:
		...
		///
		/// \param _inputHandler The GameKit::InputHandler to be bound to the GamePad
		///
		/// This function has to be called at init in your GameKit::CoreApplication subclass, with your own GameKit::InputHandler
		///
		/// \see getInputHandler
		///
		////////////////////////////////////////////////////////////
		...
		///
		/// \return The currently active GameKit::InputHandler
		///
		/// \see init
		///
		////////////////////////////////////////////////////////////
...
#endif // GameKit_GAMEPAD_HPP_

////////////////////////////////////////////////////////////
/// \class GameKit::GamePad
/// \ingroup core
///
/// GameKit::GamePad provides an interface to the state of the keyboard.
///
/// \see GameKit::InputHandler
///
////////////////////////////////////////////////////////////
